...
pub(super) type BitMaskWord = u64;
pub(super) type NonZeroBitMaskWord = NonZeroU64;
pub(super) const BITMASK_STRIDE: usize = 8;
pub(super) const BITMASK_MASK: BitMaskWord = !0;
pub(super) const BITMASK_ITER_MASK: BitMaskWord = 0x8080_8080_8080_8080;
...
#[derive(Copy, Clone)]
pub(super) struct Group(neon::uint8x8_t);
