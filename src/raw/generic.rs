...
pub(super) type BitMaskWord = GroupWord;
pub(super) type NonZeroBitMaskWord = NonZeroGroupWord;
pub(super) const BITMASK_STRIDE: usize = 8;
// We only care about the highest bit of each byte for the mask.
#[allow(clippy::cast_possible_truncation, clippy::unnecessary_cast)]
pub(super) const BITMASK_MASK: BitMaskWord = 0x8080_8080_8080_8080_u64 as GroupWord;
pub(super) const BITMASK_ITER_MASK: BitMaskWord = !0;
...
#[derive(Copy, Clone)]
pub(super) struct Group(GroupWord);
...
impl Group {
    ...
    pub(super) const WIDTH: usize = mem::size_of::<Self>();
    ...
    #[inline]
    pub(super) const fn static_empty() -> &'static [u8; Group::WIDTH] {
        #[repr(C)]
        struct AlignedBytes {
            _align: [Group; 0],
    ...
    #[inline]
    #[allow(clippy::cast_ptr_alignment)]
    pub(super) unsafe fn store_aligned(self, ptr: *mut u8) {
        // FIXME: use align_offset once it stabilizes
        debug_assert_eq!(ptr as usize & (mem::align_of::<Self>() - 1), 0);
    ...
    /// - `FULL => DELETED`
    #[inline]
    pub(super) fn convert_special_to_empty_and_full_to_deleted(self) -> Self {
